...
Location.create(address: '118 Lockwood Road', city: 'Syracuse', state: 'NY', country: 'United States', zip_code: 98394)

User.create(username: 'user1', name: 'the first user', password: 'a', user_type: 'submitter', email: 'abc@abc.com', department_id: Department.all.sample.id)
User.create(username: 'user2', name: 'the second user', password: 'a', user_type: 'approver', email: 'abc@abc.com', department_id: Department.all.sample.id)
User.create(username: 'user3', name: 'the third user', password: 'a', user_type: 'project manager', email: 'abc@abc.com', department_id: Department.all.sample.id)
